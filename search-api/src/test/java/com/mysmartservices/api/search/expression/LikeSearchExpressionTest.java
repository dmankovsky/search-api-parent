...
class LikeSearchExpressionTest {

    private SearchExpression searchExpression = new LikeSearchExpression();
    ...
    void getSpecification_Success_Test() {
        ...
        when(builder.like(eq(myFieldPath), eq("%Termin%"))).thenReturn(predicate);
