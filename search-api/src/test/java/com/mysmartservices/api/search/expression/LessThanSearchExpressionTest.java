...
class LessThanSearchExpressionTest {

    private SearchExpression searchExpression = new LessThanSearchExpression();
    ...
    void getSpecification_Success_Test() {
        ...
        when(builder.lessThan(eq(myFieldPath), eq("1"))).thenReturn(predicate);
