...
class UnequalSearchExpressionTest {

    private SearchExpression searchExpression = new UnequalSearchExpression();
    ...
    void getSpecification_Success_Test() {
        ...
        when(builder.notEqual(eq(myFieldPath), eq("1"))).thenReturn(predicate);
