...
class NotLikeSearchExpressionTest {

    private SearchExpression searchExpression = new NotLikeSearchExpression();
    ...
    void getSearchPattern_Test() {
        ...
        // Arrange
        String textualExpression = "myField!:Test";
    ...
    void getSpecification_Success_Test() {
        ...
        // Arrange
        String expressionString = "myField!:Termin";
        ...
        when(builder.notLike(eq(myFieldPath), eq("%Termin%"))).thenReturn(predicate);
