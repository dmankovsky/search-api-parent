...
class BiggerThanSearchExpressionTest {

    private SearchExpression searchExpression = new BiggerThanSearchExpression();
    ...
    void getSpecification_Success_Test() {
        ...
        when(builder.greaterThan(eq(myFieldPath), eq("1"))).thenReturn(predicate);
