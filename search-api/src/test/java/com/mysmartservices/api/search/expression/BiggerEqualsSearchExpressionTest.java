...
class BiggerEqualsSearchExpressionTest {

    private SearchExpression searchExpression = new BiggerEqualsSearchExpression();

    //****************************************************************************************************************//
    // getRepresentation tests
    //****************************************************************************************************************//
    ...
    void getSpecification_Success_Test() {
        ...
        when(builder.greaterThanOrEqualTo(eq(myFieldPath), eq("1"))).thenReturn(predicate);
