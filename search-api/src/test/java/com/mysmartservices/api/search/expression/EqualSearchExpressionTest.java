...
class EqualSearchExpressionTest {

    private SearchExpression searchExpression = new EqualSearchExpression();
    ...
    void getSpecification_Success_Test() {
        ...
        // Arrange
        String expressionString = "myField=test";
        ...
        when(builder.equal(eq(myFieldPath), eq("test"))).thenReturn(predicate);
